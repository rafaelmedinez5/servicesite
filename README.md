...
app/
  ...
  academy.py              fixed Academy plan and installment schedule
  academy_routes.py       public program page and month-one checkout
  ...
  templates/academy.html  public Academy curriculum, plan, and enrollment state
...
enrollments and the internal catalog records used for the initial USD 100 XMR
month-one payment. Existing invoices, accounts, carts, requests, service images,
